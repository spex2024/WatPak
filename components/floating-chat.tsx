...
function getAiReply(input: string): string {
  ...
  if (n.includes("business") || n.includes("generator") || n.includes("company") || n.includes("waste"))
    return "Businesses of any size can register as waste generators at demo.watpak.com. We collect fibre waste today; plastics, e-waste, and metals are coming soon."
